...
/**
 * A {@link DatabaseDialect} for Netezza.
 */
public class NetezzaSqlDatabaseDialect extends GenericDatabaseDialect {

    private final Logger log = LoggerFactory.getLogger(NetezzaSqlDatabaseDialect.class);

    /**
     * The provider for {@link NetezzaSqlDatabaseDialect}.
     */
    public static class Provider extends SubprotocolBasedProvider {
        public Provider() {
            super(NetezzaSqlDatabaseDialect.class.getSimpleName(), "netezza");
        }

        @Override
        public DatabaseDialect create(AbstractConfig config) {
            return new NetezzaSqlDatabaseDialect(config);
        }
    }
     ...
     */
    public NetezzaSqlDatabaseDialect(AbstractConfig config) {
