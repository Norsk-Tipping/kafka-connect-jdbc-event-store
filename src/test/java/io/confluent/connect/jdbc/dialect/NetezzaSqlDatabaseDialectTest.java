...
public class NetezzaSqlDatabaseDialectTest extends BaseDialectTest<NetezzaSqlDatabaseDialect> {
  ...
  public void shouldMapPrimitiveSchemaTypeToSqlTypes() {
    ...
    assertPrimitiveMapping(Type.STRING, "VARCHAR(250)");
  }
  ...
  public void shouldMapDataTypesForAddingColumnToTable() {
    ...
    verifyDataTypeMapping("VARCHAR(250)", Schema.STRING_SCHEMA);
